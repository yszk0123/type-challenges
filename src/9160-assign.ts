...
type AssignSingle<T, U> = U extends object
  ? Pick<Omit<T, keyof U> & U, Exclude<keyof T, keyof U> | keyof U>
  : T;
type Assign<T extends Record<string, unknown>, U> = U extends [
  infer Head,
  ...infer Rest,
]
  ? Assign<AssignSingle<T, Head>, Rest>
  : T;
type a = Pick<{ a: 1 } & { b: 2 }, 'a' | 'b'>;
type a0 = Pick<{ a: 1 } & Omit<{ a: 2; b: 2 }, 'a'>, 'a' | 'b'>;
type b = AssignSingle<{ a: 1; b: 2 }, { b: 3; c: 4 }>;
